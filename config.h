...
static const int follow_tag = 1; /* Non-zero means to follow when a client is sent to another tag */
...
static const char* applauncher_command[] = { "rofi", "-show", NULL };
static const char* terminal_command[]  = { "alacritty", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_p,      spawn,          {.v = applauncher_command } },
